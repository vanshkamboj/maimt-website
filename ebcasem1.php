...
<div class="list-group">
  ...
  <button type="button" onclick="window.location.href = 'syallbus/111.html';" class="list-group-item list-group-item-action"><b>BCA-111 </b>Computer and ProgrammingFundamentals</button>
  <button type="button" onclick="window.location.href = 'syallbus/112.html';" class="list-group-item list-group-item-action"><b>BCA-112 </b>Windows and PC Software</button>
  ...
  <button type="button" onclick="window.location.href = 'syallbus/116.html';" class="list-group-item list-group-item-action"><b>BCA-116 </b>Programming in c</button>
